 ...
 * @author USER
 */
public class DispathFilter implements Filter {
    
    private static final String RESOURCE_PATH = "WEB-INF\\Action.properties";
    
    private static final Logger LOGGER = Logger.getLogger(DispathFilter.class);
    ...
    public DispathFilter() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("DispathFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("DispathFilter:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        Properties action = PropertiesLoader.loadProperties(path);
        servletContext.setAttribute("ACTION", action);
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("DispathFilter()");
        }
        StringBuffer sb = new StringBuffer("DispathFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("DispathFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("DispathFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("DispathFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("DispathFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("DispathFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
